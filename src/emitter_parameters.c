...
void emitter_parameters_init(EmitterParameters* emitterParameters)
{
    ...
    emitterParameters->particleLifeTime[0] = 30.0f;
    emitterParameters->particleLifeTime[1] = 34.0f;
    ...
    emitterParameters->emissionRate = 15.0f;
    ...
    glm_vec4_zero(emitterParameters->position);
}